...
public class Contact_PO extends Base_PO {
    ...
    WebElement emailAdress_TextField;
    ...
    WebElement succesfulSubmission_Message_Text;
    public Contact_PO() {
        super();
    }
    ...
    public void setUnique_EmailAdress() {
        sendKeys(emailAdress_TextField, "AutoEmail" + generateRandomNumber(10) + "@mail.com");
    }

    public void setUnique_Comment() {
        sendKeys(comment_TextField, "Hi Teacher i am just trying what if i run this 250 times. If you see this message please follow me on twitter @yzrbrk   " + generateRandomString(20));
...
//        driver.findElement(By.xpath("//input[@name='first_name']")).sendKeys(firstName);
    ...
    public void setSpecific_Email(String email) {
        sendKeys(emailAdress_TextField, email);
    }
    ...
    public void validate_Succesful_SubmissionMessage_Text(){
        waitFor(succesfulSubmission_Message_Text);
        Assert.assertEquals(succesfulSubmission_Message_Text.getText(), "Thank You for your Message!");
    }
